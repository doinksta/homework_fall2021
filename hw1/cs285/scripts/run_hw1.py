...
def main():
    ...
    parser.add_argument('--num_agent_train_steps_per_iter', type=int, default=2)  # number of gradient steps for training policy (per iter in n_iter)
    parser.add_argument('--n_iter', '-n', type=int, default=1)

    parser.add_argument('--batch_size', type=int, default=2)  # training data collected (in the env) during each iteration
